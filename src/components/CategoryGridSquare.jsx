const CategoryGridSquare = ({ categories, onSelect, sectionRef }) => {
          ...
          <div className="category-track" style={{ animationDuration }}>
            {sequence.map((category, index) => (
              <button
                ...
                type="button"
                className="relative block min-w-[18rem] max-w-[18rem] overflow-hidden rounded-3xl border border-slate-200 bg-white text-left shadow-sm transition hover:-translate-y-1 hover:shadow-lg"
...
export default CategoryGridSquare;
